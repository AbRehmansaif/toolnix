...
export default function QrCodeGenerator() {
  ...
  const [value, setValue] = useState('https://toolnix.app');
      ...
      <div className="tool-header">
        <div className="tool-header-inner">
          ...
          <div className="tool-header-content">
            ...
            <div className="tool-header-title">QR Code Generator</div>
      ...
      <div className="tool-main">
        ...
        <div>
          <div className="tool-sidebar-card">
            <div className="sidebar-card-header">⚙️ Customization</div>
