...
import { Image as ImageIcon, Upload, X, Download, CheckCircle, ChevronRight, File as FileIcon, Loader2 } from 'lucide-react';
...
export default function PdfToJpg() {
  ...
  // Options
  const [method, setMethod] = useState('page-to-jpg'); // 'page-to-jpg', 'extract'
  ...
  const process = async () => {
    ...
    try {
      ...
      setZipFileName(`${file.name.replace(/\.[^/.]+$/, "")}_jpg.zip`);
  ...
  return (
    <div className="tool-page">
      <div className="tool-breadcrumb">
        ...
        <ChevronRight size={14} className="tool-breadcrumb-sep" />
        <span className="tool-breadcrumb-current">PDF to JPG</span>
      </div>

      <div className="tool-header">
        <div className="tool-header-inner">
          <div className="tool-header-icon" style={{ background: '#fff7ed' }}>
            <ImageIcon size={36} color="#f97316" strokeWidth={1.6} />
          </div>
          <div className="tool-header-content">
            <div className="tool-header-title">PDF to JPG</div>
        ...
        <div>
          ...
          {status === 'processing' && (
            <div className="progress-wrap" style={{ marginTop: 16 }}>
              <div className="progress-label"><span>Extracting JPGs…</span><span>{Math.round(progress)}%</span></div>
          ...
          {status === 'done' && (
            <div style={{ marginTop: 24 }}>
              <div className="result-box" style={{ marginBottom: 24 }}>
                ...
                <button className="download-btn" onClick={downloadAll}><Download size={16} /> Download Images (.zip)</button>
              </div>
          ...
          <div className="tool-sidebar-card">
            ...
            <div className="sidebar-card-body">
              ...
              <select className="sidebar-select" style={{ marginBottom: 16 }} value={method} onChange={e => setMethod(e.target.value)}>
                <option value="page-to-jpg">Page to JPG</option>
