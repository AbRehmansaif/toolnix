...
export default function PdfToPowerpoint() {
  ...
  const process = () => {
    ...
    xhr.open('POST', '/api/pdf-to-pptx/', true);
    ...
    xhr.onload = () => {
      ...
      if (xhr.status === 200) {
        ...
        let filename = file.name.replace('.pdf', '.pptx');
  ...
  return (
    <div className="tool-page">
      <div className="tool-breadcrumb">
        ...
        <ChevronRight size={14} className="tool-breadcrumb-sep" />
        <span className="tool-breadcrumb-current">PDF to PowerPoint</span>
      </div>
      ...
      <div className="tool-header">
        <div className="tool-header-inner">
          ...
          <div className="tool-header-content">
            <div className="tool-header-title">PDF to PowerPoint</div>
        ...
        <div>
          ...
          {status === 'processing' && (
            <div className="progress-wrap" style={{ marginTop: 16 }}>
              <div className="progress-label"><span>Converting to PPTX…</span><span>{Math.round(progress)}%</span></div>
          ...
          {status === 'done' && (
            <div className="result-box" style={{ marginTop: 24 }}>
              ...
              <a href={resultUrl} download={resultFilename} style={{ textDecoration: 'none' }}>
                <button className="download-btn"><Download size={16} /> Download POWERPOINT</button>
              </a>
            </div>
          )}
        </div>
          ...
          <div className="tool-sidebar-card">
            ...
            <div className="sidebar-card-body">
              ...
              >
                ...
                {status === 'processing' ? 'Converting…' : 'Convert to PPTX'}
              </button>
            </div>
          </div>
        </div>
